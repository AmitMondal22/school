        ...
        <div class="row column1">
            ...
            <div class="col-md-12">
                <div class="white_shd full margin_bottom_30">
                    ...
                    <form action="{{route('wc.sa_profile')}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <!-- <div class="row padding_infor_info"> -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" placeholder="Enter Confirmed password" id="passwordc" name="password_confirmation">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
