                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="{{route('orgregister')}}" method="POST">
                                    @csrf
                                    ...
                                    <p class="mt-5 login-form__footer">Have account <a href="{{route('orglogin')}}" class="text-primary">Sign Up </a> now</p>
                                    </p>
                                </div>
                            </div>
                        </div>
