...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">My School</h4>
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped verticle-middle table-hover">
                            <thead>
                                <tr>
                                    <th scope="col">SL</th>
                                    ...
                                    <td>
                                         ...
                                         <div class="dropdown custom-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <li><a class="dropdown-item" href="{{route('school.addclass_schoolid', [$sdata->schoolid])}}"> <i class="fa fa-plus color-muted m-r-5"></i> Class Room</a></li>
